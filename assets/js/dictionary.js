export var classes = [["Вор", "Подрезка: можешь скинуть карту, чтобы подрезать д…вместно валят монстра, можешь подрезать их обоих.", "Кража: можешь скинуть  карту, что бы попытаться с… кража, иначе тебя лупят, и ты теряешь 1 Уровень."],
...
export var curses = [["Уровень!", "Потеря 1 Уровня!"],
...
export var items = [["Чарующая Дуда", "(для всех)", "+1 к попытке смыться", "1 Рука Большая 300 голд"],
...
export var races = [["Хафлинг", "-1 к Смывке", "На каждом ходу можешь продать одну шмотку за двойную цену(цена других шмоток не меняется)."],
...
export var spells = [["Радиоактивноэлектрокислотное Зелье", "+5 любой стороне.", "200 голд"],
...
export var monsters = [["уровень 2", "Бешеная Цыпа", "+3 против Хафлинг", "непотребство: теряешь 1 уровень", "0 уровень", "1 сокровище"],
